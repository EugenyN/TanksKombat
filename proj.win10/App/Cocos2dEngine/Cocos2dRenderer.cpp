...
Cocos2dRenderer::Cocos2dRenderer(int width, int height, float dpi, float renderScale, DisplayOrientations orientation, CoreDispatcher^ dispatcher, Panel^ panel)
    : m_app(nullptr)
    , m_width(width)
    , m_height(height)
    , m_dpi(dpi)
