...
void OpenGLESPage::CreateRenderSurface()
{
    ...
    {
		DisplayInformation^ currentDisplayInformation = DisplayInformation::GetForCurrentView();
		mCustomResolutionScale = currentDisplayInformation->RawPixelsPerViewPixel;

        mRenderSurface = mOpenGLES->CreateSurface(swapChainPanel, nullptr, &mCustomResolutionScale);
...
void OpenGLESPage::StartRenderLoop()
{
    ...
    auto workItemHandler = ref new Windows::System::Threading::WorkItemHandler([this, dispatcher](Windows::Foundation::IAsyncAction ^ action)
    {
        ...
        {
            mRenderer = std::make_shared<Cocos2dRenderer>(panelWidth, panelHeight, mDpi, mCustomResolutionScale, mOrientation, dispatcher, swapChainPanel);
        }
